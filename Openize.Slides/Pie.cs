...
namespace Openize.Slides
{
    ...
    public class Pie
    {
        ...
        /// <summary>
        /// Property to get or set the PieShapeFacade.
        /// </summary>
        public PieFacade Facade { get => _Facade; set => _Facade = value; }
        ...
        /// <summary>
        /// Constructor of the Pie class initializes the object of PieShapeFacade and populates its fields.
        /// </summary>
        public Pie()
        {
            _Facade = new PieFacade();
        ...
        /// </summary>
        /// <param name="PieFacades">A list of PieShapeFacade objects.</param>
        /// <returns>A list of Pie objects.</returns>
        public static List<Pie> GetPies(List<PieFacade> PieFacades)
        {
            List<Pie> Pies = new List<Pie>();
            try
            {
                foreach (var facade in PieFacades)
                {
                    Pie Pie = new Pie
                    {
            ...
            {
                string errorMessage = Common.OpenizeException.ConstructMessage(ex, "Getting Pie Shapes");
        ...
        public void Remove()
        {
            _Facade.RemoveShape(this.Facade.Pie);
        }
    }
}
